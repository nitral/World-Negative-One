...
function getSeriesInfo(series)
	...
	if not info_table["Show Name"] then
		...
		-- Make Complete Info --
		series_complete_info = series_complete_info .. "        " .. "--------##--------" .. info_table["Show Name"] .. "--------##--------" .. "\r\n"
		...
		if info_table["Latest Episode"] then
			series_complete_info = series_complete_info .. "Last Episode  - S " .. info_table["Latest Season"] .. "-" .. info_table["Latest Episode Number"] .. "  " .. info_table["Latest Episode Name"] .. "  l  Date: " .. info_table["Latest Episode Date"] .. "\r\n"
		end
		if info_table["Next Episode"] then
			series_complete_info = series_complete_info .. "Next Episode - S " .. info_table["Next Season"] .. "-" .. info_table["Next Episode Number"] .. "  " .. info_table["Next Episode Name"] .. "  l  Date: " .. info_table["Next Episode Date"] .. "\r\n"
		end
		series_complete_info = series_complete_info .. "\t\t  " .. "Country: " .. info_table["Country"] .. "\r\n"
		series_complete_info = series_complete_info .. "\t   " .. "Genres: " .. info_table["Genres"]:gsub("|", "I") .. "\r\n"
		series_complete_info = series_complete_info .. "\t       " .. "Episode Duration: " .. info_table["Runtime"] .. " minutes" .. "\r\n"
		series_complete_info = series_complete_info .. "=--=--=--=--=--=-->>>World Negative One<<<--=--=--=--=--=--="
