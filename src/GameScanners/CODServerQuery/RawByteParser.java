public class RawByteParser
{
	...
	/** Extracts a C formatted string out of the byte buffer. The buffer is not affected by this method. The
	 * resulting string is stored into the StringBuffer.
	 * 
	 * @param offset
	...
	/** Read a long C value from the data buffer. This method takes 4 bytes of the buffer and convert them into a
	 * single long. The buffer is not affected by this method.
	 * 
	 * @param offset
	...
	/** Read a byte value from the data buffer and returns the unsigned representation. The buffer is not affected by
	 * this method.
	 * 
	 * @param offset
	 *                index of the first byte to be parsed
